    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        private Rect GetSafeArea()
        {
            ...
            if (Application.isEditor && Sim != SimDevice.None)
            {
                ...
                safeArea = new Rect(UnityEngine.Screen.width * nsa.x, UnityEngine.Screen.height * nsa.y, UnityEngine.Screen.width * nsa.width,
                    UnityEngine.Screen.height * nsa.height);
            }
#endif
